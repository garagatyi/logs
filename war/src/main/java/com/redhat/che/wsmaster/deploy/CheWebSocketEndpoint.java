...
/**
 * Implementation of {@link BasicWebSocketEndpoint} for Che packaging. Add only mapping "/output".
 */
@ServerEndpoint(value = "/output", configurator = GuiceInjectorEndpointConfigurator.class)
